...
class Settings(BaseSettings):
    ...
    # CORS 설정
    CORS_ALLOWED_ORIGINS: str = "http://localhost:3000,http://localhost:8000,http://127.0.0.1:3000,http://127.0.0.1:8000,ws://localhost:8000,ws://127.0.0.1:8000,http://localhost:5173,http://localhost:5174,ws://localhost:5173,ws://localhost:5174"  # 허용할 origin (콤마로 구분, 예: "http://localhost:3000,https://example.com,wss://example.com")
